...
const steps = [
    { icon: ScanLineIcon, label: "Analyzing your project" },
...
const LoaderSteps = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col justify-center items-center bg-gray-950 relative overflow-hidden text-white'>
