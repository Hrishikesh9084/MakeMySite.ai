  ...
  const handlePurchase = async (planId: string) => {
      try {
        ...
        window.location.href = data.payment_link;
          ...
          toast.error(error?.response?.data?.message || 'Something went wrong while processing your request.', error.message)
          console.log(error)
      }
  }
    ...
    <>
      ...
      <div className='w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]'>
        <div className='text-center mt-16'>
          ...
          <p className='text-gray-400 text-sm max-w-md mx-auto mt-2'>Start for free an scale up as you grow. Find the perfect plan for your content creating needs</p>
        </div>
        ...
        <p className='mx-auto text-center text-sm max-w-md mt-5 text-white/60 font-light'>Project <span className='text-white'>Creation / Revision</span> consume <span className='text-white'>5 credits</span>. You can purchase more credits to create more projects.</p>
      </div>
    </>
  )
}
